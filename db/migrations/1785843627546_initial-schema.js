...
CREATE TABLE IF NOT EXISTS jobs (
    ...
    status VARCHAR(30) NOT NULL DEFAULT 'pending' CHECK (status IN ('pending', 'matching', 'accepted', 'en_route', 'started', 'completed', 'cancelled', 'disputed', 'open', 'in_progress', 'released', 'refunded')),
...
export const down = (pgm) => {
  pgm.sql(`
    ...
    DROP TABLE IF EXISTS verification_docs CASCADE;
