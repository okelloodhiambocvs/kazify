                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`text-[9px] font-mono font-bold px-2 py-0.5 rounded border uppercase ${
                      d.status === 'pending' ? 'bg-amber-500/10 text-amber-400 border-amber-500/20' : 'bg-sky-500/10 text-sky-400 border-sky-500/20'
                    }`}>
                      ...
                      contracts.filter(c => c.status === 'active').map((contract) => (
                        ...
                        >
                          ...
                          <div className="text-right font-mono">
                            <span className="text-orange-400 font-bold block">KES {(contract?.amount || 0).toLocaleString()}</span>
                            <span className="text-[9px] text-sky-400 uppercase tracking-widest block font-bold mt-0.5">● ACTIVE</span>
                          </div>
                        </div>
                      ))
                    )}
