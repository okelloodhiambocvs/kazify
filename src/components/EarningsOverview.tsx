      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-slate-950/80 border border-slate-800 rounded-2xl flex items-center justify-between shadow-md">
          <div className="space-y-1">
            ...
            <span className="text-[9px] font-mono text-sky-400 block font-semibold">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-7 p-4 bg-slate-950/80 border border-slate-800 rounded-2xl shadow-md space-y-4">
          <div className="flex justify-between items-center pb-2 border-b border-slate-900">
            ...
            <span className="text-[9px] font-mono text-sky-400 px-2 py-0.5 bg-sky-500/10 rounded-lg border border-sky-500/20">
              ALL RELEASED
            </span>
          </div>
              ...
              completedJobs.map((job) => (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <span className="text-[8px] font-mono font-semibold text-sky-400 uppercase">
                      Escrow Paidout
                    </span>
                  </div>
                </div>
